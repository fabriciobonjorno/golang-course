...
func main() {
	...
	var productsWithCategories []Product
	db.Preload("Category").Find(&productsWithCategories)
	for _, p := range productsWithCategories {
		println(p.ID, p.Name, p.Price, p.Category.Name)
	}
